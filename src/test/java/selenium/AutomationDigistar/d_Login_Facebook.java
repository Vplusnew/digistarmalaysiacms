...
public class d_Login_Facebook{
	...
	@Test
public void Login_valid_Facebook() throws InterruptedException { //TC1 Login FB
			WebDriver driver;
...
//					driver.findElement(By.xpath("(//input[@id='identifierId'])[1]")).sendKeys("fatahalim245@gmail.com");
					driver.findElement(By.xpath("(//input[@id='email'])[1]")).sendKeys("cheklist01@gmail.com");
					driver.findElement(By.xpath("(//input[@id='pass'])[1]")).sendKeys("4321lupa");
					driver.findElement(By.xpath("(//label[@id='loginbutton'])[1]")).click();
					Thread.sleep(10000);
					driver.close();
				}
			}
